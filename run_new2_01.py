...
for name5 in num_lst1:
		stanford_area_2_vox201.append( 'C1-limitlossyG-lossyA-ai_r1_stanford_area_2_vox20_dec' )
		stanford_area_4_vox201.append( 'C1-limitlossyG-lossyA-ai_r1_stanford_area_4_vox20_dec' )
		Church_vox161.append( 'C1-limitlossyG-lossyA-ai_r1_Church_vox16_dec' )
		Courthouse_vox161.append( 'C1-limitlossyG-lossyA-ai_r1_Courthouse_vox16_dec' )
		Ignatius_vox111.append( 'C1-limitlossyG-lossyA-ai_r1_Ignatius_vox11_dec' )
		QQdog_vox151.append( 'C1-limitlossyG-lossyA-ai_r1_QQdog_vox15_dec' )
		Truck_vox151.append( 'C1-limitlossyG-lossyA-ai_r1_Truck_vox15_dec' )
...
dir_lst=list([
'stanford_area_2_vox20\\r01\\',
'stanford_area_4_vox20\\r01\\',
'Church_vox16\\r01\\',
'Courthouse_vox16\\r01\\',
'Ignatius_vox11\\r01\\',
'QQdog_vox15\\r01\\',
'Truck_vox15\\r01\\',
])
