...
homedir = os.getcwd()
dirpath = homedir + '\\'
draco_enc = 'draco_encoder_ford1.exe'
draco_dec = 'draco_decoder_ford1.exe'
pce = 'pc_evalue_ford1.exe'
#os.mkdir('log')
logpath = 'log\\'
...
for name4 in num_lst1:
		ford_01_file_lst.append( 'C1-limitlossyG-lossyA-ai_r1_Ford_01_1mm_dec-0' + str(name4))
	
for name4 in num_lst1:
		ford_02_file_lst.append( 'C1-limitlossyG-lossyA-ai_r1_Ford_02_1mm_dec-0' + str(name4))
	
for name4 in num_lst1:
		ford_03_file_lst.append( 'C1-limitlossyG-lossyA-ai_r1_Ford_03_1mm_dec-0' + str(name4))
