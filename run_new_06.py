...
for name5 in num_lst1:
		bridge_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r6_bridge_1mm_dec')
		double_T_section_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r6_double_T_section_1mm_dec')
		intersection1_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r6_intersection1_1mm_dec' )
		intersection2_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r6_intersection2_1mm_dec' )  
		straight_road_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r6_straight_road_1mm_dec' )
		T_section_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r6_T_section_1mm_dec' ) 
...
dir_lst=list([
'bridge_1mm\\r06\\',
'double_T_section_1mm\\r06\\',
'intersection1_1mm\\r06\\',
'intersection2_1mm\\r06\\',
'straight_road_1mm\\r06\\',
'T_section_1mm\\r06\\',
])
