...
for name4 in num_lst1:
        Livox_01_all_file_lst.append( 'C1-limitlossyG-lossyA-ai_r6_Livox_01_all_1mm_dec-' + str(name4).zfill(4))
        Livox_02_all_file_lst.append( 'C1-limitlossyG-lossyA-ai_r6_Livox_02_all_1mm_dec-' + str(name4).zfill(4))	
...
dir_lst=list([
'Livox_01_all_in_one_1mm\\r06\\',
'Livox_02_all_in_one_1mm\\r06\\',
])
