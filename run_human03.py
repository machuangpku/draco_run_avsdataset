...
homedir = os.getcwd()
dirpath = homedir + '\\'
draco_enc = 'draco_encoder_old3.exe'
draco_dec = 'draco_decoder_old3.exe'
pce = 'pc_evalue_human_3.exe'
#os.mkdir('log')
logpath = 'log\\'
...
for name4 in num_lst1:
		basketball_player_file_lst.append( 'C1-limitlossyG-lossyA-ai_r3_basketball_player_vox11_dec-' + str(name4).zfill(8))
		exercise_file_lst.append( 'C1-limitlossyG-lossyA-ai_r3_exercise_vox11_dec-' + str(name4).zfill(8))
		dancer_file_lst.append( 'C1-limitlossyG-lossyA-ai_r3_dancer_vox11_dec-' + str(name4).zfill(8))
		model_file_lst.append( 'C1-limitlossyG-lossyA-ai_r3_model_vox11_dec-' + str(name4).zfill(8))   
