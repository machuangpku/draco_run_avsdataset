...
for name5 in num_lst1:
		bridge_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r4_bridge_1mm_dec')
		double_T_section_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r4_double_T_section_1mm_dec')
		intersection1_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r4_intersection1_1mm_dec' )
		intersection2_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r4_intersection2_1mm_dec' )  
		straight_road_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r4_straight_road_1mm_dec' )
		T_section_1mm_file_2st.append( 'C1-limitlossyG-lossyA-ai_r4_T_section_1mm_dec' ) 
...
dir_lst=list([
'bridge_1mm\\r04\\',
'double_T_section_1mm\\r04\\',
'intersection1_1mm\\r04\\',
'intersection2_1mm\\r04\\',
'straight_road_1mm\\r04\\',
'T_section_1mm\\r04\\',
])
