...
homedir = os.getcwd()
dirpath = homedir + '\\'
draco_enc = 'draco_encoder_ford2.exe'
draco_dec = 'draco_decoder_ford2.exe'
pce = 'pc_evalue_ford2.exe'
#os.mkdir('log')
logpath = 'log\\'
...
for name4 in num_lst1:
		ford_01_file_lst.append( 'C1-limitlossyG-lossyA-ai_r2_Ford_01_1mm_dec-0' + str(name4))
	
for name4 in num_lst1:
		ford_02_file_lst.append( 'C1-limitlossyG-lossyA-ai_r2_Ford_02_1mm_dec-0' + str(name4))
	
for name4 in num_lst1:
		ford_03_file_lst.append( 'C1-limitlossyG-lossyA-ai_r2_Ford_03_1mm_dec-0' + str(name4))
