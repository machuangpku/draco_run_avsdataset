...
homedir = os.getcwd()
dirpath = homedir + '\\'
draco_enc = 'draco_encoder_old1.exe'
draco_dec = 'draco_decoder_old1.exe'
pce = 'pc_evalue_human_1.exe'
#os.mkdir('log')
logpath = 'log\\'
...
for name4 in num_lst1:
		basketball_player_file_lst.append( 'C1-limitlossyG-lossyA-ai_r1_basketball_player_vox11_dec-' + str(name4).zfill(8))
		exercise_file_lst.append( 'C1-limitlossyG-lossyA-ai_r1_exercise_vox11_dec-' + str(name4).zfill(8))
		dancer_file_lst.append( 'C1-limitlossyG-lossyA-ai_r1_dancer_vox11_dec-' + str(name4).zfill(8))
		model_file_lst.append( 'C1-limitlossyG-lossyA-ai_r1_model_vox11_dec-' + str(name4).zfill(8))   
